...
import { Calculator, Dumbbell, ChevronRight, Flame, Trophy, StickyNote as StickyNoteIcon, FileText, Plus, Trash2, Activity, Zap, LayoutGrid, Wind, Gem, Sparkles } from 'lucide-react';
        ...
        <div className="relative z-10 flex flex-col lg:flex-row justify-between items-start lg:items-end gap-6 lg:gap-8">
          <div className="space-y-4">
            ...
            <div className="pt-2 flex flex-wrap gap-4 relative z-50">
              <button
                type="button"
                onPointerUp={() => { window.open('https://zyro-theta.vercel.app/', '_blank'); }}
